...
constexpr auto qt_meta_stringdata_CLASSRegisterWindowENDCLASS = QtMocHelpers::stringData(
    ...
    "",
    "on_ButtonStudent_clicked",
    "on_ButtonTeacher_clicked",
    "on_ButtonCancel_clicked",
    "on_return_to_RegisterWindow"
);
...
Q_CONSTINIT const QMetaObject RegisterWindow::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSRegisterWindowENDCLASS_t,
        ...
        // method 'on_ButtonStudent_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'on_ButtonTeacher_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'on_ButtonCancel_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'on_return_to_RegisterWindow'
        QtPrivate::TypeAndForceComplete<void, std::false_type>
    >,
    nullptr
} };
...
void RegisterWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->on_ButtonStudent_clicked(); break;
        case 2: _t->on_ButtonTeacher_clicked(); break;
        case 3: _t->on_ButtonCancel_clicked(); break;
        case 4: _t->on_return_to_RegisterWindow(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &RegisterWindow::return_to_LoginWindow; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void RegisterWindow::return_to_LoginWindow()
{
