...
constexpr auto qt_meta_stringdata_CLASSStudentWindowENDCLASS = QtMocHelpers::stringData(
    ...
    "on_ButtonStudentInfo_clicked",
    "on_return_to_StudentWindow",
    "on_ButtonSelect_clicked",
    "on_tableViewSC_doubleClicked",
    "QModelIndex",
    "index"
);
...
Q_CONSTINIT const QMetaObject StudentWindow::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSStudentWindowENDCLASS_t,
        ...
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'on_ButtonStudentInfo_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'on_return_to_StudentWindow'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'on_ButtonSelect_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'on_tableViewSC_doubleClicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
...
void StudentWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->on_ButtonStudentInfo_clicked(); break;
        case 3: _t->on_return_to_StudentWindow(); break;
        case 4: _t->on_ButtonSelect_clicked(); break;
        case 5: _t->on_tableViewSC_doubleClicked((*reinterpret_cast< std::add_pointer_t<QModelIndex>>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (StudentWindow::*)();
            if (_t _q_method = &StudentWindow::return_to_LoginWindow; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void StudentWindow::return_to_LoginWindow()
{
