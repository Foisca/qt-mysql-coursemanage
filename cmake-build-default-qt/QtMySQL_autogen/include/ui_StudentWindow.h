...
public:
    ...
    void setupUi(QMainWindow *StudentWindow)
    {
        ...
        tableViewSC->setGeometry(QRect(130, 50, 511, 581));
        ButtonSelect = new QPushButton(centralwidget);
        ButtonSelect->setObjectName("ButtonSelect");
        ButtonSelect->setGeometry(QRect(10, 110, 91, 41));
        ...
        ButtonReturn->setGeometry(QRect(10, 160, 91, 41));
